...
//        WebDriver driver = new ChromeDriver();
    ...
    public static void typeQueryString(WebDriver webDriver, ExtentTest test,String queryString) {
        try{
            webDriver.findElement(By.name("q")).sendKeys(queryString + Keys.ENTER);
            test.log(LogStatus.PASS, "Queried : "+queryString , test.addScreenCapture(ScreenshotHelper.capture(webDriver)));
    ...
    public static void launchFlipkart(WebDriver webDriver, ExtentTest test) {
        try{
            webDriver.get("https://flipkart.com");
            test.log(LogStatus.PASS, "Navigated to Flipkart.com" , test.addScreenCapture(ScreenshotHelper.capture(webDriver)));
    ...
    public static void checkFlipkartLogo(WebDriver webDriver, ExtentTest test) {
        try{
            test.log(LogStatus.PASS, "Flipkart logo found" , test.addScreenCapture(ScreenshotHelper.capture(webDriver)));
